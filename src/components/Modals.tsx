    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true" onClick={(event) => {
      ...
      <section className="rules-modal">
        ...
        <div className="rules-content">
          <section><h3>目的</h3><p>相手のライフを 0 にすると勝利。各プレイヤーの場には AI を最大 3 体まで出せます。</p></section>
          <section><h3>ターン</h3><p>通常は 2 アクションです。先攻の最初のターンだけ 1 アクション、ドローなし、攻撃不可です。先攻は初期手札 5 枚、後攻は初期手札 4 枚です。</p></section>
          <section><h3>カード</h3><ul><li>AI: 場に出して攻撃・防御します。</li><li>指令: 1回使うとトラッシュへ行きます。</li><li>メモリー: 1枚だけ置ける継続枠です。</li></ul></section>
          <section><h3>攻撃と防御</h3><p>攻撃した AI は消耗します。場の AI で防御した場合、防御値と攻撃値が同じなら相打ち、上回れば攻撃 AI だけトラッシュへ行きます。</p></section>
          <section><h3>手札防御</h3><p>1ターンに1回まで、場の状態に関係なく条件を満たす手札の AI で攻撃を止められます。手札の防御 AI はトラッシュへ行きます。</p></section>
          <section><h3>属性とAI効果</h3><p>属性相性はありません。効果は一部AIカードだけが個別に持ちます。火は攻撃とオーバーヒート時の補充、水はドローと手札交換、風はテンポ、土は防御と手札が薄い時の回収が得意です。</p></section>
        </div>
      </section>
    </div>
  );
